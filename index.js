...
function addMinionGroup() {
    ...
    group.code = $('<div name="miniongroup">').attr("group_index", group_index).append(internal);
    ...
    el_template.change(function () {
        let array = common_stat_lines[$(this).val()];
...
function initButtons() {
    $('#add_minion').click(addMinionGroup);
    let template_select = $('select[name="minion_template"]');
    for (let t in common_stat_lines) {
